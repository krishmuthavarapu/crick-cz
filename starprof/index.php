...
<head>
  ...
  <link rel="shortcut icon" href="img/logostar.png" type="image/x-icon">
  <title>Star Profs</title>
  <!-- Font Awesome -->
    ...
    <div class="container">
      ...
      <form class="" action="" method="post">
        ...
        <div class="text-center white-text mx-2 mt-lg-5 mt-3 wow fadeIn">
          <img src="img/logostar.png" class="logo-pop bg-transparent" alt="" />
...
<h3><b>&</b></h3>
          <p style="font-size:20px" class="">
            <strong>Lucky Winner Get <b style="background: #006633;
    padding: 5px;">FREE SBI PO TESTSERIES</b> Prelims</strong>
          </p>
